...
class DCGANAE128(nn.Module):
    ...
    def __init__(self, nc=3, latent_z_size=1024):
        ...
        self.discriminator = nn.Sequential(
            ...
            nn.Conv2d(ndf * 16, latent_z_size, 4, 1, 0, bias=False),
            nn.Sigmoid()
        ...
        self.generator = nn.Sequential(
            ...
            nn.ConvTranspose2d(latent_z_size, ngf * 16, 4, 1, 0, bias=False),
...
# ------------------------------------------------------------------------------
    ...
    def forward(self, x):
        ...
        return self.generator(z), z.view(x.shape[0], -1)
